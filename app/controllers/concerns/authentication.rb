module Authentication
  ...
  def redirect_if_authenticated
    redirect_to root_path, warning: "You are already logged in." if user_signed_in?
  end

  def authenticate_user!
    store_location
    redirect_to login_path, warning: "You need to login to access that page." unless user_signed_in?
  end
